...
function BankLogo({ code, size = 40 }: { code: string; size?: number }) {
    ...
    const imageUrl = `https://raw.githubusercontent.com/casperstack/thai-banks-logo/master/src/th-banks-logo-medium/${normalizedCode}.png`;
    return (
        <img
            src={imageUrl}
            alt={code}
            ...
            onError={(e) => { e.currentTarget.src = '/placeholder-bank.png'; }}
        />
    );
}
